<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ctrlFuneralPaymentHistory.ascx.cs" Inherits="Funeral.Web.UserControl.ctrlFuneralPaymentHistory" %>
<div class="col-lg-12">
    <div class="table-responsive">
        <asp:GridView ID="gvInvoices" OnRowDataBound="gvInvoices_OnRowDataBound" runat="server" Width="100%" CssClass="table table-striped table-bordered table-hover"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="AmountPaid" HeaderText="Amount" DataFormatString="{0:n}" ReadOnly="True" />
