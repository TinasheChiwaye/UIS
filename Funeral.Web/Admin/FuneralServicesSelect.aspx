<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="FuneralServicesSelect.aspx.cs" Inherits="Funeral.Web.Admin.FuneralServicesSelect" %>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox MaxLength="30" runat="server" ID="txtDueDate" type="text" class="form-control" ReadOnly="true"></asp:TextBox>
                                                <%--<asp:DropDownList ID="ddlCemetery" runat="server" DataTextField="Name" DataValueField="CountryCode" CssClass="form-control m-b"></asp:DropDownList>--%>
                    ...
                    <div class="row">
                                ...
                                <ContentTemplate>
                                    <div class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <asp:TextBox MaxLength="10" runat="server" ID="txtDiscount" onkeypress="return isDecimalNumber(event,this);" name="txtTime" type="text" class="form-control" AutoPostBack="true" OnTextChanged="eveDiscountChange" Text="0"></asp:TextBox>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="btn-group">
                                    <div class="form-group">
                                        <asp:Button ID="btnPrint" CssClass="btn btn-sm btn-primary" runat="server" Text="Print" OnClick="btnPrintClick" />
                                    </div>
                                </div>
                            </div>
                        </div>
