        ...
        <div class="middle-box text-center loginscreen animated fadeInDown">
            <div class="ibox">
                <div class="ibox-title">
                    ...
                    <h2>&nbsp;</h2>
                    <h2>UIS Policy Administration</h2>
                    <h2>&nbsp; </h2>
                </div>
                <div class="ibox-title">
                ...
                <div class="ibox-content">
                    <div>
                        ...
                        <a href="ForgetPassword.aspx"><small>Forgot password?</small></a>
                        <a href="NewRegistration.aspx"><small>New Registration</small></a>
                        <p class="m-t"><small>Unplugg IT Solutions &copy; <%=DateTime.Now.Year %></small> </p>
                        <p>
