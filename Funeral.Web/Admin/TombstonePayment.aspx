<%@ Page Title="Tombstone payment system" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="TombstonePayment.aspx.cs" Inherits="Funeral.Web.Admin.TombstonePayment" %>

<%@ Register Src="~/UserControl/ctrlTombstonePaymentHistory.ascx" TagName="ucTomstonePaymentHistory" TagPrefix="uc" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <uc:ucTomstonePaymentHistory runat="server" ID="ucPaymenthistory" />
    </div>
</asp:Content>
