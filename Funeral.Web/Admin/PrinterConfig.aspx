<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="PrinterConfig.aspx.cs" Inherits="Funeral.Web.Admin.PrinterConfig" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="msgInstallWCPP" style="display:none;">    
        ...
        <p>
            <a href="PrintReceipt.aspx">You can go and test the printing page</a>
        </p>
    ...
    <script type="text/javascript">
        ...
        function wcppDetectOnSuccess(){
            ...
            if(wcppVer.substring(0,1) == "2")
                window.location.href = "PrintReceipt.aspx";
