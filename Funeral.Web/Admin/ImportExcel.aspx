            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div runat="server" class="row" id="GridviewData">
                        ...
                        <%--<div class="col-lg-6">
                            <div class="table-responsive">
                                <asp:GridView ID="gvDependentMapping" runat="server" Width="100%" CssClass="table table-striped table-bordered table-hover"
                                    AutoGenerateColumns="True" EmptyDataText="There are no member to display." OnRowDataBound="gvDependentMapping_RowDataBound" >
                                    <PagerStyle CssClass="pagination-ys" />
                                    <Columns>
                                        <asp:TemplateField HeaderText="Dependent Column Name">
                                            <ItemTemplate>
                                                <asp:DropDownList ID="ddDependentColumn" Style="width: 300px;" runat="server"></asp:DropDownList>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>                                  
                                </asp:GridView>
                            ...
                            <div class="col-lg-2">
                                <div class="form-group">
                                    <asp:Button runat="server" ID="Button1" Width="95%" CssClass="btn btn-md btn-primary" OnClick="btnSubmit_Click" Visible="false" Text="Submit" />
                                </div>
                            </div>
                        </div>--%>
                    </div>
