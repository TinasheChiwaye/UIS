...

    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                app = client.GetApplictionByParlourID(ParlourId);
                if (app != null)
                {
        ...
        {
            var agentList = client.GetAllAgent(ParlourId);
        ...
        {
            FamilyDependencyModel[] objFamilyDependencyModel = client.FamilyDependency(ParlourId, MemberId);
        ...
        public void bindTotalPremium()
        {
            ...
            txtTotalPremium.Text = client.SumPremium(ID, ParlourId).ToString(Currency.Trim() + " 0.00");
        }
        ...
        private void BindMemberToUpdate()
        {
            ...
            {
                PolicyModel objPolicyModel = client.GetPlanSubscriptionByPlanId(model.fkiPlanID, ParlourId).ToList().FirstOrDefault();
                ...
                txtUnderwriter.Text = client.GetPlanUnderwriterByPlanId(model.fkiPlanID);
                txtDebitdate.Text = FormatDateTime(model.DebitDate.ToString());
        ...
        private void SelectFamilyDependency(int DependencyId)
        {
            ...
            ObjFamilyDependencyModel = client.SelectFamilyDependencyById(DependencyId);
        ...
        {
            FuneralServiceReference.FuneralServicesClient client = new FuneralServiceReference.FuneralServicesClient();
            PolicyModel objPolicyModel = client.GetPlanSubscriptionByPlanId(id,new Guid( parlorId)).ToList().FirstOrDefault();
        ...
        {
            FuneralServiceReference.FuneralServicesClient client = new FuneralServiceReference.FuneralServicesClient();
            PolicyModel objPolicyModel = client.GetPlanSubscriptionByPlanIdNewMember(id).ToList().FirstOrDefault();
            List<string> Response = new List<string>();
            try
            {
                if (objPolicyModel != null)
        ...
        protected void gridNoteList_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                client.DeleteMemberNote(Convert.ToInt32(e.CommandArgument));
                BindNotesList();
        ...
        protected void btnDependecySubmit_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                try
                {
                    ...
                    ObjFamilyDependencyModel = client.GetDependencByIDNum(DependencyIdNumber, ParlourId, MemberId);
                    ...
                    else
                    {
                        ...
                        int documentId = client.SaveFamilyDependency(ObjFamilyDependencyModel);
        ...
        protected void btnDependecyUpdate_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                try
                {
                    ...
                    int documentId = client.UpdateFamilyDependency(ObjFamilyDependencyModel);
        ...
        protected void gvFamilyDependency_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                client.DeleteDependentById(Convert.ToInt32(e.CommandArgument));
                bindDependency();
                bindTotalPremium();
            }
            ScriptManager.RegisterStartupScript(this, this.GetType(), "goToTab5", "goToTab(5);", true);
        ...
        {
            List<MembersModel> model = client.GetPolicyByMemberIDNumber(txtIdNumber.Text, this.ParlourId).ToList();
        ...
        {
            MembersModel model = client.GetMemberByID(selectedMemberId, ParlourId);
            if ((model == null))
            {
        ...
        {
            txte_tpremium.Text = client.SumPremium(selectedMember, ParlourId).ToString(Currency.Trim() + " 0.00");
        }
        protected void btnEditPolicy_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                ...
                MembersModel model = client.GetMemberByID(Convert.ToInt32(MemberIdNumber), ParlourId);
                if (model == null)
                {
        ...
        {
            int DependencyCopiedPolicyMemberIdNumber = client.GetLastCopiedMemberForDependency();
