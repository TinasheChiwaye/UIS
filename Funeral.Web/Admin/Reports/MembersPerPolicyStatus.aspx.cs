...
{
    public partial class MembersPerPolicyStatus : AdminBasePage
    {
        ...
        public void BindJoinedMembersByDate()
        {
            ...
            com.Parameters.Add(new SqlParameter("@branch", txtPolicy.Text));
            ...
            adp.Fill(dt);
            var strExpr = "PolicyStatus like '%tiv%'";            
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                reportParameters.Add(new ReportParameter("txtReportName", "Members Per Branch " + txtPolicy.Text));
