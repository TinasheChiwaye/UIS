...
{
    public partial class JoinedMembersByDate : AdminBasePage
    {
        ...
        public void BindJoinedMembersByDate()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                reportParameters.Add(new ReportParameter("txtReportName", "Members Joined Between " + txtDateFrom.Text + " And " + txtDateTo.Text));
