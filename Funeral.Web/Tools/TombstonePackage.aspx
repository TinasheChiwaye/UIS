<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="TombstonePackage.aspx.cs" Inherits="Funeral.Web.Tools.TombstonePackage" %>
            ...
            <div class="ibox ">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Tombstone Package Management</h5>
                    </div>
                                            ...
                                            <asp:TemplateField HeaderText="Actions">
                                                <ItemTemplate>
                                                    <% if (this.HasEditRight)
                                                        {%>
                                                    <asp:LinkButton runat="server" ID="lbtnEditDependant" ToolTip="Click here To Edit Service" CommandArgument='<%#Eval("PackageName")+"~"+Eval("pkiPackageID") %>' CommandName="EditService"><i class="fa fa-edit"></i></asp:LinkButton>
                                                    &nbsp;
                                                 <%} %>
