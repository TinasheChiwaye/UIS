...
{
    public class OtherPaymentsSearchResult<SearchType, ResultType> : BaseResult where SearchType : OthrePaymentSearch
    {
        public OtherPaymentsSearchResult(SearchType searchData, List<ResultType> dataResult, Predicate<ResultType> filterPredicate)
        {
            this.SearchParameters = searchData;
            int startIndex = (searchData.PageNum - 1) * searchData.PageSize;

            //if (searchData.SearchPolicyId == null) searchData.SearchPolicyId = searchData.SearchId;
            //if(searchData.SearchId == null) searchData.SearchId = " ";


            if (searchData.SearchPolicyId != null || searchData.SearchId != null && filterPredicate!=null)
            {
